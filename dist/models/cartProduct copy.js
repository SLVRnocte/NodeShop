...
class CartProduct {
    ...
    static init(databaseController) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          belongsToCart INT NOT NULL REFERENCES Carts(id) ON DELETE CASCADE ON UPDATE CASCADE,
          productID INT NOT NULL REFERENCES Products(id) ON DELETE CASCADE ON UPDATE CASCADE,
...
//# sourceMappingURL=cartProduct copy.js.map