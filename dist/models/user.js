...
let User = User_1 = class User {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!result) {
                return new Promise(res => {
                    database_1.DatabaseController.query(`INSERT INTO ${User_1.tableName} (name, email, updatedAt, createdAt) VALUES ($1, $2, $3, $3) RETURNING *`, [this.name, this.email, now]).then(result => {
                ...
                return database_1.DatabaseController.query(`UPDATE ${User_1.tableName} SET name=$1, email=$2, updatedAt=$3 WHERE id=$4`, [this.name, this.email, now, this.id]);
            }
        });
    }
    delete() {
    ...
    static createInstanceFromDB(dbProduct) {
        ...
        return new User_1(dbProduct.name, dbProduct.email, dbProduct.id);
    }
};
